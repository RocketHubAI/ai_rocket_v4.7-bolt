...
export const NotificationBell: React.FC<NotificationBellProps> = ({ onOpenSettings, onOpenReports }) => {
    ...
    if (notification.action_url) {
      if (notification.action_url === 'settings' && onOpenSettings) {
        ...
        (notification.action_url === '/reports' ||
         notification.action_url === '/?openReports=true' ||
         notification.action_url.includes('openReports=true')) &&
        onOpenReports
      ) {
        onOpenReports();
      } else if (notification.action_url.startsWith('/') && !notification.action_url.startsWith('//')) {
