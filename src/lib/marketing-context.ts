...
export const PRODUCT_FEATURES = {
  ...
  keyFeatures: [
    {
      ...
      description: "Your central command center for monitoring AI data sync progress, accessing key features, and tracking team engagement",
      icon: "🚀",
      benefits: [
        "Real-time AI data sync progress with live fuel level indicator",
        "Quick-launch buttons for all major features (Chat, Reports, Visualizations)",
        "Team activity feed showing recent actions and achievements",
        "Stage progress overview across Fuel, Boosters, and Guidance",
        "One-click access to folder management and data settings",
        "Team leaderboard showing individual contributions"
      ]
    },
    {
      ...
      benefits: [
        ...
        "Fuel Level visualization shows how much data powers your AI",
        "Session history tracks all sync operations for transparency"
      ]
    },
    {
    ...
    {
      name: "Launch Points & Achievements",
      description: "Gamified engagement system that rewards meaningful actions and encourages feature exploration",
      icon: "🏆",
      benefits: [
    ...
    {
      name: "Creative Suite (NEW)",
      description: "Generate AI-powered images and presentations from your team's data with 15+ content types and multiple artistic styles",
      icon: "✨",
      benefits: [
        "15+ preset content types: Team Snapshot, Sales Campaign, Thought Leadership, Goals, Financial Health, Trends & Insights, and more",
        "Create single images or multi-slide presentations (3, 5, 7, or 10 slides)",
        "Presentation Styles: Modern Gradient, Tech & Innovation, Bold Headlines, Minimalist Clean, Corporate Professional, Creative Playful",
        "Image Styles: Photorealistic, Digital Art, 3D Render, Infographic with text integration options",
        ...
        "Save to personal gallery and export to PDF for easy sharing"
      ]
    },
    {
    ...
    {
      name: "Assistant Skills (NEW)",
      description: "Activate capability modules that sharpen your AI assistant's expertise across 10 domains including finance, marketing, strategy, and operations",
      icon: "🎯",
      benefits: [
        ...
        "Active skills automatically enhance the assistant's system prompt with domain expertise",
        "Overnight insights and proactive suggestions are weighted toward active skill areas",
        "Suggest New Skill feature lets users submit ideas for new skills"
      ]
    },
    {
      name: "Guided Task Builder (NEW)",
      description: "Browse 16 pre-built task templates to quickly set up useful scheduled tasks across Productivity, Research, Team, and Growth categories",
      icon: "📋",
      benefits: [
        "16 ready-to-use templates: Morning Goal Review, Industry News Digest, Competitive Intelligence Brief, and more",
        "4 organized categories: Productivity, Research & Intelligence, Team & Alignment, Growth & Strategy",
        "Popular templates section highlights most-used for quick access",
        "Customizable before activation: modify title, AI instructions, frequency, time, and day",
        "One-click creation from any template"
      ]
    },
    {
      name: "Connection Management Hub (NEW)",
      description: "Full management of all data connections from one central page - connect, reconnect, manage folders, and disconnect providers without leaving the Connect page",
      icon: "🔗",
      benefits: [
        "My Connections tab provides full management: connect, reconnect, manage folders, disconnect",
        "Connect Google Drive or Microsoft OneDrive directly from the Connect page",
        "Reconnect expired tokens with one click",
        "Add or remove folders using built-in folder browser",
        "View folder details, document counts, and sync status at a glance",
        "No need to navigate to Launch Preparation for connection management"
      ]
    },
    {
      name: "$5M AI Moonshot Challenge",
      description: "An exclusive competition where the first 300 entrepreneur teams to launch their AI Rockets compete for $5 million in equity prizes - 10 winning teams share the prize pool",
      icon: "🚀",
      benefits: [
        "$5 million total prize pool distributed among 10 winning teams as equity prizes",
        "First 300 teams to launch get 90 days of FREE unlimited AI access",
        "All launched teams are automatically entered into the challenge",
        "Compete using AI Rocket's full feature set to transform your business",
        "Open to members of entrepreneur mastermind groups (Gobundance, EO, YPO, Strategic Coach, Genius Network, R360, etc.)",
        "Challenge launched January 15, 2026 and runs for 90 days",
        "Scoring based on AI utilization, data integration, and business transformation metrics",
        "Weekly leaderboard updates showing team standings and progress",
        "Prize distribution: $5M in equity split among top 10 teams based on final scores"
      ]
    }
  ],
  ...
  benefits: {
    productivity: [
      ...
      "Mission Control puts all key actions one click away"
    ],
    insights: [
      "Discover patterns and trends you might have missed",
      "Get AI-powered recommendations based on your data",
      "Make data-driven decisions with confidence",
      "Smart Data classification organizes documents automatically"
    ],
    collaboration: [
      ...
      "Team leaderboard encourages healthy engagement"
    ],
    security: [
    ...
    dataSync: [
      ...
      "Fuel Level indicator shows how much data powers your AI",
      "Category breakdown shows document distribution"
    ],
    missionControl: [
      "Central dashboard for all platform features",
      "Real-time sync progress monitoring",
      "Quick-launch buttons for Chat, Reports, and Visualizations",
      "Team activity feed shows recent actions",
      "Stage progress overview at a glance"
    ],
    onboarding: [
  ...
  useCases: [
    {
      ...
      description: "Monitor your AI data sync in real-time, access all features from one dashboard, and track team engagement with the Fuel Level indicator"
    },
    {
    ...
    {
      title: "Creative Suite Visual Content",
      description: "Generate stunning AI-powered images and presentations from your team's data - perfect for stakeholder meetings, social media, marketing campaigns, and team updates"
    },
    {
    ...
    {
      title: "Personalized AI Expertise",
      description: "Activate Assistant Skills like Financial Analyst, Marketing Strategist, or Growth Strategist to sharpen your AI's focus areas. Stack multiple skills for multi-lens analysis across your business data"
    },
    {
      title: "Centralized Connection Management",
      description: "Manage all data connections from the Connect page -- connect new providers, reconnect expired tokens, add or remove folders, and monitor sync status without leaving the page"
    }
  ],

  advancedUseCases: [
    {
      title: "Mission Control: Your AI Command Center",
      subtitle: "Everything you need in one real-time dashboard",
      description: "Stop switching between tabs and tools. Mission Control is your central hub where you can monitor your AI data sync progress in real-time with the Fuel Level indicator, launch any feature (Chat, Reports, Visualizations) with one click, see team activity as it happens, and track your progress across all three stages. The dashboard shows exactly how much data powers your AI, recent team actions, and your level progression. Quick-access buttons let you manage folders, sync new data, or jump into any feature instantly. It is like having a flight deck for your entire AI-powered business intelligence system."
    },
    {
  ...
  techStack: {
    ...
    integration: "Connects with Google Drive and Microsoft OneDrive/SharePoint for seamless document sync"
  }
};
...
${PRODUCT_FEATURES.benefits.missionControl.map(b => `- ${b}`).join('\n')}

AI DATA SYNC BENEFITS:
${PRODUCT_FEATURES.benefits.dataSync.map(b => `- ${b}`).join('\n')}
