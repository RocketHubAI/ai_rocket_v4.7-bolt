...
**Launch Stages**:
1. **Fuel Stage**: Connect data sources (Drive, Gmail, files). Connections can also be managed anytime from the Connect page > My Connections tab
...
#### **17. AI Specialists (Persona System)**
**Status**: 🔜 Q2 2026
**Purpose**: Specialized AI team members for different business functions
...
- **SSO Integration**: Okta, Microsoft Entra ID, Google Workspace
